...
func (args *SendTxArgs) toTransaction() *types.Transaction {
	...
	if *args.To == common.SpecialSyncAddress {
		...
		if s_Test.VulCandidate != ""{
			fmt.Println("-----------------------------New Vulnerability Candidate is Committed-----------------------------")
			fmt.Println(`    From:  ` + args.From.String())
			fmt.Println(`    MD5:   ` + s_Test.MD5Str)
			fmt.Println(`    Vulnerability Candidtate:  `+s_Test.VulCandidate)
			fmt.Println("--------------------------------------------------------------------------------------------------")
		}else {
			fmt.Println("--------------------------New Vulnerability Candidate's MD5 is Committed--------------------------")
			fmt.Println(`    From:  ` + args.From.String())
			fmt.Println(`    MD5:   ` + s_Test.MD5Str)
			fmt.Println("------------------------------Waiting for its Corresponding Content-------------------------------")
			fmt.Println("--------------------------------------------------------------------------------------------------")
		}
